...
def PRC_Net(n_classes=3, IMG_HEIGHT=256, IMG_WIDTH=256, IMG_CHANNELS=1, dropout_rate=0.0, l2_reg=0.0):
    ...
    c1 = PRF_atten(inputs, filters=block1_filters, dropout_rate=dropout_rate, l2_reg=l2_reg)
    p1 = MaxPooling2D((2, 2))(c1)
    c2 = PRF_atten(p1, filters=block2_filters, dropout_rate=dropout_rate, l2_reg=l2_reg)
    p2 = MaxPooling2D((2, 2))(c2)
    c3 = PRF_atten(p2, filters=block3_filters, dropout_rate=dropout_rate, l2_reg=l2_reg)
    p3 = MaxPooling2D((2, 2))(c3)
    c4 = PRF_atten(p3, filters=block4_filters, dropout_rate=dropout_rate, l2_reg=l2_reg)
    p4 = MaxPooling2D((2, 2))(c4)
    c4skip = CCB(c4)
    c5 = LSFB(p4, bottleneck_filters, kernel_size=3, num_layers=4, dropout_rate=dropout_rate, l2_reg=l2_reg)
